    ...
    <form onSubmit={handleSubmit}>
      <div className="flex flex-col relative">
        <span>
          ...
          <input type="text" value={params} onChange={handleParamsChange} placeholder="Additional parameters" className="h-12 rounded border-gray-300 px-4 outline-none w-1/3"/>
